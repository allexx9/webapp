...
import PageFundsVaultTrader from './pageFundsVaultTrader'
import PageFundDetailsVaultTrader from './pageFundDetailsVaultTrader'
      ...
      return (
        <Switch>
          ...
          <Route exact path={match.path+"/pools"}
            render={(props) => <PageFundsVaultTrader {...props}               
            blockNumber={blockNumber}
            accounts={accounts}
            ethBalance={ethBalance} 
            allEvents={allEvents}
          ...
          <Route path={match.path+"/pools/:dragoid/:dragocode"}
            render={(props) => <PageFundDetailsVaultTrader {...props}               
            blockNumber={blockNumber}
            accounts={accounts}
            ethBalance={ethBalance} 
            allEvents={allEvents}
