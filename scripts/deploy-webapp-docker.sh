...
docker tag webapp-v1 rb-registry.endpoint.network/webapp-v1:$DATE-$NUMBER
docker push rb-registry.endpoint.network/webapp-v1:$DATE-$NUMBER
# printenv
...
./rancher kubectl set image deployment/webapp-v1-staging webapp-v1-staging=rb-registry.endpoint.network/webapp-v1:$DATE-$NUMBER
